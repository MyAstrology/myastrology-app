...
export default function KundaliScreen() {
  ...
  const handleRefresh = useCallback(() => {
    setRefreshing(true);
    loadKundali();
    // WebView-এর onLoadEnd-এ refreshing false করা হবে
  }, [loadKundali]);
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      {error && (
        <View style={styles.errorContainer}>
          ...
          <TouchableOpacity style={styles.retryBtn} onPress={loadKundali}>
      ...
      <WebView
        ...
        // পুল-টু-রিফ্রেশ সক্রিয় করতে (WebView ভিতরে স্ক্রল থাকলে)
        pullToRefreshEnabled
        // অথবা RefreshControl ব্যবহার করতে চাইলে:
        // refreshControl={
        //   <RefreshControl
