...
export default function PanjikaScreen() {
  ...
  const injectedJS = `
    (function(){
      ...
      // ওয়েবসাইটের হেডার, ফুটার ও নেভিগেশন লুকানো
      ...
      // অপ্রয়োজনীয় কিছু সেকশন লুকানো (ঐচ্ছিক)
      hide('faqSection');
      hide('seow');
      hide('ctaw');
      // বডির প্যাডিং সরানো
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      {error && (
        <View style={styles.errorContainer}>
          ...
          <TouchableOpacity style={styles.retryBtn} onPress={loadPanjika}>
