...
.panel h2,.panel h3,.panel-hdr,.boy-panel>h2,.girl-panel>h2{
  ...
  color:#3a2218!important;margin:0 0 12px!important;
  padding-bottom:8px!important;border-bottom:1.5px solid #ede0ce!important;
}
/* ── Labels ── */
...
/* ── Date/time grids ── */
.mm-dt-grid-date,.mm-dt-grid-time{display:flex!important;gap:6px!important;}
.mm-dt-grid-date .sel-ctrl,.mm-dt-grid-time .sel-ctrl{flex:1!important;}
/* ── Coords grid ── */
.coords{display:flex!important;flex-direction:column!important;gap:6px!important;}
...
.mm-gps-btn{
  ...
  padding:8px 10px!important;cursor:pointer!important;flex-shrink:0!important;
...
.city-wrap>div{display:flex!important;gap:6px!important;align-items:center!important;}
...
.city-suggestions li{padding:10px 12px!important;cursor:pointer!important;border-bottom:1px solid #f0e8d8!important;font-size:.88rem!important;color:#3a2218!important;}
/* ── GPS message ── */
.mm-gps-msg{font-size:.78rem!important;color:#5c3d2e!important;display:block!important;min-height:1.2em!important;}
/* ── Calculate button ── */
.calc-btn{
  ...
  cursor:pointer!important;margin-top:12px!important;display:block!important;
}
/* ── Results area ── */
#resultsArea{padding:8px 0!important;}
.score-hero{background:#fff!important;border-radius:14px!important;border:1.5px solid #e0cdbc!important;padding:16px 14px!important;margin-bottom:10px!important;box-shadow:0 2px 8px rgba(0,0,0,.06)!important;}
.mm-shloka-box{margin-bottom:10px!important;}
.card{background:#fff!important;border-radius:14px!important;border:1.5px solid #e0cdbc!important;padding:14px!important;margin-bottom:10px!important;box-shadow:0 2px 8px rgba(0,0,0,.06)!important;}
.section-title{font-size:.95rem!important;font-weight:700!important;color:#3a2218!important;margin:0 0 12px!important;padding-bottom:8px!important;border-bottom:1.5px solid #ede0ce!important;}
/* ── Tables ── */
