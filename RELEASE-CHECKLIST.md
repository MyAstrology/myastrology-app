...
> Internal testing-এ আছে **versionCode 5 / v1.0.2**
> রেপোতে প্রস্তুত **versionCode 5 → পরের বিল্ডে 6 / v1.0.3**
>
...
## 🆕 v1.0.3 (versionCode 6) — এই বিল্ডে ফোনে যা যাচাই করবেন
...
- ⬜ সেটিংসে **"পঞ্চাঙ্গের অবস্থান"** ও **বিল্ড নম্বর ৬** দেখায়
