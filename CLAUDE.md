...
- ⛔ **"প্লাগিনটা আছে" আর "প্লাগিনটা কাজ করেছে" এক নয়।** `withR8.js`-এর
  regex Expo SDK 53/54-র টেমপ্লেট-আকৃতি চিনত না, তাই নীরবে ফিরে যেত আর
  প্রতিটি রিলিজ minify ছাড়াই যেত (Play Console-এ Obfuscation ১%)।
  এখন **না চিনলে বিল্ড থেমে যায়**, আর `npm run verify-r8` তিনটে আকৃতি ও
  দুটো ব্যর্থতার ক্ষেত্র `node_modules` ছাড়াই চালিয়ে দেখে।
...
- ⚠️ `app.json`-এর `versionCode` হলো **ভিত্তি**; `autoIncrement` বিল্ডের
  ...
  মিনিটের বিল্ডের শেষে** ফিরিয়ে দেয়। এখন ভিত্তি **২১**, সংস্করণ **১.২.১**।
