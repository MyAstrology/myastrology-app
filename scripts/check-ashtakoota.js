...
/* রাশিকূট — পঞ্জিকার ছাপা যোটকচক্রের নিয়ম বান্ডিলেও পৌঁছেছে কিনা।
   ⚠️ ৩০/৮/২০২৬ — আগে এখানে "সাত-ধাপ (খ ৩৩)" ধরা হত। মালিক জানিয়েছেন
   খ ৩৫–৩৬-এর ছাপা ছকই প্রামাণ্য (AstroSage/Prokerala-র সঙ্গে মেলে), আর
   ছকের নিয়ম: রাশি-সম্বন্ধ ২/১২ · ৫/৯ · ৬/৮ হলে ০, নইলে ৭।
   ছকের কর্ণের ঘর ২৮ — অর্থাৎ এক রাশি + এক নক্ষত্র + এক চরণেও ভকূট ৭। */
{
  const R = e.rashiNames;
  const CASES = [
    ['মেষ', 'মেষ', 0, 1, 1, 2, 7, 'এক রাশি ভিন্ন নক্ষত্র'],
    ['মেষ', 'মেষ', 0, 0, 2, 2, 7, 'এক রাশি এক নক্ষত্র এক চরণ'],
    ['মেষ', 'মেষ', 0, 0, 1, 3, 7, 'এক রাশি এক নক্ষত্র ভিন্ন চরণ'],
    ['মেষ', 'বৃষ', 2, 2, 1, 4, 0, 'ভিন্ন রাশি এক নক্ষত্র (দ্বিদ্বাদশ)'],
    ['মেষ', 'তুলা', 0, 13, 1, 2, 7, 'সমসপ্তক — রাজযোটক'],
    ['মেষ', 'সিংহ', 0, 9, 1, 2, 0, 'নবপঞ্চম — ছকে গুণ নেই'],
    ['কুম্ভ', 'মকর', 23, 21, 2, 4, 0, 'মালিকের দম্পতি — ছাপা ছকে মোট ১৮']
  ];
