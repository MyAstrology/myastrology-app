...
const BASELINE = 2;    /* ২০২৬-০৯-১৪ — ৩২ → ২। প্রতিটি ইনলাইন করা
                          src/*.js ও js/*.js ব্লক এখন ওয়েবসাইটের ফাইলের
                          সঙ্গে বাইট-ধরে এক; বাকি দুটো **ইচ্ছাকৃত ফর্ক**:

                          · js/main.js — অ্যাপের কপিতে ১৮টি base64 ছবি
                            বসানো (৮১৬ KB বনাম ওয়েবের ২১০ KB)। ব্লক
                            অদলবদল করলে বান্ডল ১.৩৬ MB → ৭৬০ KB নেমে
                            ছবিগুলো মুছে যায় — একবার হয়েছিল, ফেরানো হয়েছে।
                          · js/renderers/compatibility-renderer.js —
                            WebView-এ navigator.share চলে না, তাই শেয়ারের
                            বদলে "কপি করুন"। বাকিটা ওয়েবসাইটের মতোই, আর
                            বিনামূল্যের প্রিন্ট ফেরানো হয়নি (নইলে অ্যাপে
                            পেইড PDF বাইপাস হতো)।

                          ⚠️ নতুন ব্লক পোর্ট করার আগে দেখুন অ্যাপের কপিটা
                          ওয়েবের চেয়ে অনেক বড় কি না — বড় হলে ওটা ফর্ক,
                          অদলবদল করলে হাতে বসানো জিনিস মুছে যাবে।      */   /* ২০২৬-০৯-১৩ — match-making.js পুরো নতুন করে তৈরি
